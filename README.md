...
@font-face {
  ...
  src: url(https://github.com/max32002/swei-xd/raw/master/WebFont/CJK%20TC/SweiXDPearlCJKtc-Regular.woff2) format("woff22")
  , url(https://github.com/max32002/swei-xd/raw/master/WebFont/CJK%20TC/SweiXDPearlCJKtc-Regular.woff) format("woff");
}
```
